...
$this->title = 'Заявки';
?>
<div class="zayvka-index" style="max-width: 1200px; margin: 20px auto; padding: 20px; background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
    ...
    <?= GridView::widget([
        ...
        'tableOptions' => ['class' => 'table table-striped table-bordered'], // Добавлены классы для стилизации
    ]); ?>

    <div class="block1" style="display: flex; justify-content: center; gap: 20px; margin-top: 20px;">
        <a href="catalog"><button type="button" class="btn btn-new" style="padding: 10px 20px; border-radius: 5px;">Перейти в каталог</button></a>
